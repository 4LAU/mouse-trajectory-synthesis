"""ZIMT feature-match finetuned model with magnitude-weighted endpoint correction."""
...
_CKPT_PATH = (
    ...
    else Path("training/zimt_fm_best.pt")
)

if not _CKPT_PATH.exists():
    raise FileNotFoundError(f"FM checkpoint not found: {_CKPT_PATH}")
...
print(
    f"[zimt_fm] ZIMT-FM ({_cfg['d_model']}d, {_cfg['n_layers']}L, "
